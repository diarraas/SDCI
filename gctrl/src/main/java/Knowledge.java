...
class Knowledge {
    ...
    static final String gw = "GWI";
    static final double gw_lat_threshold = 69;
    ...
    private final String olddestip = "192.168.0.254";
    private String newdestip = "192.168.0.253"; 
    private String oldgwip ; //N/A
    private String lbip ; //N/A
    ...
    void start() throws Exception {
        ...
        //TODO : update gwinfo
        //gwinfo.put("\"name\"", "\"dc1\"");
        gwinfo.put("\"image\"", "\"gateway2:latest\"");
        gwinfo.put("\"network\"", "\"(id=gwi2-eth0,ip="+newdestip+"/24)\"");
